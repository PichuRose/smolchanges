...
public class PehkuiSupport {
    ...
    public static void setup() {
        ...
        ScaleRegistries.SCALE_MODIFIERS.put(new ResourceLocation("smolchanges:sc_scale"), modifier);
        SUScaleModifier.set(modifier);
        ScaleType suType = ScaleType.Builder.create()
                .affectsDimensions()
                .addDependentModifier(SUScaleModifier.get())
                .build();
        ScaleRegistries.SCALE_TYPES.put(new ResourceLocation("smolchanges:smolchanges_scale"), suType);
